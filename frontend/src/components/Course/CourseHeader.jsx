        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-6"> 
          <div className="space-y-4 flex-1">
            ...
            <div className="flex flex-wrap gap-4 text-sm text-gray-500">
              <div className="flex items-center gap-2 bg-gray-50 px-3 py-1.5 rounded-full border border-gray-100 shadow-xs">                <User className="w-4 h-4 text-teal-600" />
              ...
              <div className="flex items-center gap-2">
                ...
                <span className='text-gray-500'>Diperbarui: {formatDate(course.updated_at)}</span>
              </div>
            </div>
          </div>
